...
export default function GraficasBanco ({cambios, select}){
  ...
  return(
  <div className='px-2 py-3 h-[560px] w-[390px] xl:w-[500px] 2xl:w-[600px] mx-auto overflow-y-scroll border border-gray-300 bg-white rounded-lg shadow-lg grid grid-cols-1 gap-3'>
    <CurvaFaseCambio 
