  ...
  return (
    <>
      ...
      <div className="p-8 h-screen flex gap-4 flex-wrap">
        <div className="animate-pulse bg-white border rounded-xl shadow w-72 h-80 flex flex-col justify-between">
          <div className="flex items-center bg-gray-300 rounded-t h-[121px]">
