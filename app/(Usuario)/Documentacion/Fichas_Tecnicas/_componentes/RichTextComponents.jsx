...
export const RichTextComponents = {
  ...
  block: {
    h1: ({children}) => (<h1 className="text-5xl py-10">{children}</h1>),
    h2: ({children}) => (<h2 className="text-4xl py-10">{children}</h2>),
    h3: ({children}) => (<h3 className="text-3xl py-4">{children}</h3>),
    h4: ({children}) => (<h4 className="text-2xl py-4">{children}</h4>),
    h5: ({children}) => (<h5 className="text-xl py-4">{children}</h5>),
    normal: ({children}) => (<p className="text-md font-light ml-2 mb-2">{children}</p>),
    h6: ({children}) => (<p className="-mt-4 pb-5 text-center font-thin">{children}</p>),
