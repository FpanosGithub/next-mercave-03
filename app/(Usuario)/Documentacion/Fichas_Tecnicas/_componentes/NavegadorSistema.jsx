...
export default function NavegadorSistema({sistema, material, id, tipo, id_tipo, version}) {
  ...
  return (
  <div className='flex flex-col w-[1142px] justify-end items-center gap-3'>
  {/* LINEA DE SISTEMA */}
    <div className="flex py-4 px-6 items-start gap-6 bg-blue-100 rounded-lg">
      <span className='mx-4'
            onClick = {()=>setOpen(!open)}>
        {open? (<ChevronDownIcon className="w-6 text-gray-400"/>):(<ChevronRightIcon className="w-6 text-gray-400"/>)}
      </span>
      <div className='flex w-[1010px] items-start gap-6'>
