...
export default function Home() {
  return (
    <div className="flex flex-col h-screen justify-between p-5 overflow-y-auto">
      ...
      <div className="flex place-items-center">
        <div>
          ...
          <div className='grid grid-cols-3 md:grid-cols-3 lg:grid-cols-3 lg:p-0'>
          ...
          <div className='grid grid-cols-3 md:grid-cols-3 lg:grid-cols-3 lg:p-0'>
            <Card enlace="#" titulo="Operaciones de cambio" descripcion="Información de operaciones de cambio realizados. Valores de los cambios. Alarmas. Mantenimientos realizados" imagen="/imagenes/varios/power.png"/>
          </div>
          ...
          <div className='grid grid-cols-3 md:grid-cols-3 lg:grid-cols-3 lg:p-0'>
            ...
            <Card enlace="/gestor_documentacion" titulo="Estudio" descripcion="Herramienta de Gestión Documental" imagen="/imagenes/vehiculos/portabobinas.jpg"/>
          </div>
        </div>
      </div>
    </div>
