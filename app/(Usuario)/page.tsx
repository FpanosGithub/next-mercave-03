...
export default function Home() {
  return (
    <div className="flex flex-col h-screen p-5 justify-between overflow-y-auto">
      <h1 className='text-2xl font-semibold'>Herramienta de seguimiento del proyecto Mercave</h1>
      <div className="flex place-items-center">
        <div className='grid sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-2 lg:p-0'>
          <div>
            <h2 className='text-slate-500 pt-10 pb-4'>MATERIAL RODANTE</h2>
            <div className='grid sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-2'>
          ...
          <div>
            ...
            <div className='grid sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-2 h-5/6'>
