...
return(
    ...
    <div className='border bg-white rounded-lg shadow-sm overflow-hidden flex flex-col items-start max-w-[500px] h-[300px]'>
        <Link href={`/${enlace}`}>
            ...
            <div className="p-5 self-stretch">
                ...
                <p className="text-sm text-gray-500 pb-2 line-clamp-4">{descripcion}</p>
            </div>
        </Link>
    </div>
)
